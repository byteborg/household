...
lidCutOutType="LCD"; // [ LCD:LCD Shield , DHT:Dht Shield,DHThorizontal:Dht Shield, BUTTON:Button Shield , NONE:No cutout]
            ...
            difference () {
                   ...
                   if (airSlits){
                    ...
                    translate([innerSizeX/2,-wallThickness-0.01,0]) {
                        // Antenne
                        translate([ -12, 0, 13]) cube([7, 20, 7]);
                        // USB
                        if (usbHeight != 0.0)  {
                            translate([ -4, 0, -1+usbHeight]) cube([12,4 ,1+6.2]);
